        ...
        <div class="row flex-nowrap">
            <div class="col-auto px-0">
                <div id="sidebar" class="collapse collapse-horizontal show border-end">
                    <div id="sidebar-nav" class="list-group border-0 rounded-0 text-sm-start min-vh-100">
                        ...
                        <a id="popularOffers" href="#" class="list-group-item border-end-0 d-inline-block text-truncate" data-bs-parent="#sidebar"><span style="color: darkmagenta">Your most popular offers</span> </a>
            ...
            <main class="col ps-md-2 pt-2">
                <div class="page-header pt-3">
                    <h2>Your most popular offers</h2>
                </div>
                <hr>
                <div class="row">
                    <div class="col-9">
